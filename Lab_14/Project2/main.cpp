...
void Draw() {
    ...
    model1 = glm::translate(model1, glm::vec3(0.1f, 0.35f, 0.5f));
    model1 = glm::scale(model1, glm::vec3(0.015f, 0.015f, 0.015f));
    ...
    model2 = glm::translate(model2, glm::vec3(0.0f, -0.2f, 0.5f));
    ...
    model3 = glm::translate(model3, glm::vec3(-0.55f, 0.0f, 0.5f));
    model3 = glm::scale(model3, glm::vec3(0.012f, 0.012f, 0.012f));
    model3 = glm::rotate(model3, glm::radians(30.0f), glm::vec3(0.0f, 0.0f, 1.0f));
    ...
    model4 = glm::scale(model4, glm::vec3(0.035f, 0.035f, 0.035f));
